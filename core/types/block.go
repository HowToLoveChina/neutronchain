...
// Package types contains data types related to ntc consensus.
package types
...
// Header represents a block header in the ntc blockchain.
type Header struct {
...
// Block represents an entire block in the ntc blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the ntc RLP block format.
