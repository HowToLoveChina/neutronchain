...
func makeTestState() (Database, *ntcdb.MemDatabase, common.Hash, []*testAccount) {
	// Create an empty state
	mem, _ := ntcdb.NewMemDatabase()
	db := NewDatabase(mem)
...
// account array.
func checkStateAccounts(t *testing.T, db ntcdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db ntcdb.Database, root common.Hash) error {
...
func checkStateConsistency(db ntcdb.Database, root common.Hash) error {
