...
// stateObject represents an ntc account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of ntc address of the account
	data     Account
	db       *StateDB
...
// Account is the ntc consensus representation of accounts.
