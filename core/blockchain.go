...
// Package core implements the ntc consensus protocol.
package core
...
import (
	...
	"github.com/ntc/go-ntc/common/mclock"
...
// available in the database. It initialises the default ntc Validator and
// Processor.
func NewBlockChain(chainDb ntcdb.Database, config *params.ChainConfig, engine consensus.Engine, vmConfig vm.Config) (*BlockChain, error) {
...
func (bc *BlockChain) InsertReceiptChain(blockChain types.Blocks, receiptChain []types.Receipts) (int, error) {
	...
	for i, block := range blockChain {
		...
		if batch.ValueSize() >= ntcdb.IdealBatchSize {
