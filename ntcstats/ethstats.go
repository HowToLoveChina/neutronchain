...
// Service implements an ntc netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.ntc      // Full ntc service if monitoring a full node
	les    *les.Lightntc // Light ntc service if monitoring a light node
...
func New(url string, ethServ *eth.ntc, lesServ *les.Lightntc) (*Service, error) {
