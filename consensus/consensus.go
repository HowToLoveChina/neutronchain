...
// Package consensus implements different ntc consensus engines.
package consensus
...
type Engine interface {
	// Author retrieves the ntc address of the account that minted the given
	...
	VerifySeal(chain ChainReader, header *types.Header, posShareCheck bool, difficulty *big.Int) error
