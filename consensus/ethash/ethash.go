...
// all blocks' seal as valid, though they still have to conform to the ntc
// consensus rules.
...
// still have to conform to the ntc consensus rules.
...
// they still have to conform to the ntc consensus rules.
