...
func newTestLDB() (*ntcdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "ntcdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := ntcdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db ntcdb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db ntcdb.Database, t *testing.T) {
	const n = 8
