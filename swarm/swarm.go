...
import (
	...
	"github.com/ntc/go-ntc/contracts/chequebook"
	...
	"github.com/ntc/go-ntc/swarm/api"
	httpapi "github.com/ntc/go-ntc/swarm/api/http"
	"github.com/ntc/go-ntc/swarm/fuse"
	"github.com/ntc/go-ntc/swarm/network"
	"github.com/ntc/go-ntc/swarm/storage"
)
...
func NewSwarm(ctx *node.ServiceContext, backend chequebook.Backend, ensClient *ntcclient.Client, config *api.Config, swapEnabled, syncEnabled bool, cors string) (self *Swarm, err error) {
