...
type downloadTester struct {
	...
	stateDb ntcdb.Database // Database used by the tester for syncing from peers
	peerDb  ntcdb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb, _ = ntcdb.NewMemDatabase()
