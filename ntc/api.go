...
import (
	...
	"github.com/ntc/go-ntc/trie"
)

const defaultTraceTimeout = 5 * time.Second

// PublicntcAPI provides an API to access ntc full node-related
// information.
type PublicntcAPI struct {
	e *ntc
}

// NewPublicntcAPI creates a new ntc protocol API for full nodes.
func NewPublicntcAPI(e *ntc) *PublicntcAPI {
	return &PublicntcAPI{e}
}

// Etherbase is the address that mining rewards will be send to
func (api *PublicntcAPI) Etherbase() (common.Address, error) {
	return api.e.Etherbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Etherbase)
func (api *PublicntcAPI) Coinbase() (common.Address, error) {
	return api.Etherbase()
}

// Hashrate returns the POW hashrate
func (api *PublicntcAPI) Hashrate() hexutil.Uint64 {
...
func NewPublicMinerAPI(e *ntc) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *ntc) *PrivateMinerAPI {
...
// PrivateAdminAPI is the collection of ntc full node-related APIs
...
// admin methods of the ntc service.
func NewPrivateAdminAPI(eth *ntc) *PrivateAdminAPI {
...
// PublicDebugAPI is the collection of ntc full node APIs exposed
...
// related public debug methods of the ntc service.
func NewPublicDebugAPI(eth *ntc) *PublicDebugAPI {
...
// PrivateDebugAPI is the collection of ntc full node APIs exposed over
...
// private debug methods of the ntc service.
func NewPrivateDebugAPI(config *params.ChainConfig, eth *ntc) *PrivateDebugAPI {
