...
// Package chequebook package wraps the 'chequebook' ntc smart contract.
//
...
import (
	...
	"github.com/ntc/go-ntc/contracts/chequebook/contract"
	"github.com/ntc/go-ntc/core/types"
	"github.com/ntc/go-ntc/crypto"
	"github.com/ntc/go-ntc/log"
	"github.com/ntc/go-ntc/swarm/services/swap/swap"
)
...
// Cash cashes the cheque by sending an ntc transaction.
