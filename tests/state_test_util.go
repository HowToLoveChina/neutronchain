...
import (
	...
	"github.com/ntc/go-ntc/crypto/sha3"
...
// See https://github.com/ntc/EIPs/issues/176 for the test format specification.
...
func makePreState(db ntcdb.Database, accounts core.GenesisAlloc) *state.StateDB {
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/ntc/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
