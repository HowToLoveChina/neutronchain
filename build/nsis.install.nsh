Name "gntc ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/ntc/go-ntc/issues"
!define UPDATEURL "https://github.com/ntc/go-ntc/releases"
!define ABOUTURL "https://github.com/ntc/go-ntc#ntc-go"
...
# Install gntc binary
Section "Gntc" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gntc}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gntc.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gntc.exe" "attach" "" ""
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Gntc incoming peers (TCP:10101)" ""  6 1 1 2147483647 1 "$INSTDIR\gntc.exe" "" "" "ntc" 10101 "" "" ""
  SimpleFC::AdvAddRule "Gntc outgoing peers (TCP:10101)" ""  6 2 1 2147483647 1 "$INSTDIR\gntc.exe" "" "" "ntc" "" 10101 "" ""
  SimpleFC::AdvAddRule "Gntc UDP discovery (UDP:10101)" "" 17 2 1 2147483647 1 "$INSTDIR\gntc.exe" "" "" "ntc" "" 10101 "" ""

  # Set default IPC endpoint (https://github.com/ntc/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ntc_SOCKET" "R" "HKLM" "\\.\pipe\gntc.ipc"
  ${EnvVarUpdate} $0 "ntc_SOCKET" "A" "HKLM" "\\.\pipe\gntc.ipc"
