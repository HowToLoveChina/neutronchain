...
# 1. install gntc for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gntc
# 5. create gntc, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable ntc_SOCKET
...
!define GROUPNAME "ntc"
!define APPNAME "Gntc"
!define DESCRIPTION "Official Go implementation of the ntc protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gntc is installed global
