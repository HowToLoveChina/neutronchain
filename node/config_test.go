...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gntc.ipc", false, filepath.Join(os.TempDir(), "gntc.ipc")},
		{"data", "gntc.ipc", false, "data/gntc.ipc"},
		{"data", "./gntc.ipc", false, "./gntc.ipc"},
		{"data", "/gntc.ipc", false, "/gntc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gntc.ipc", true, `\\.\pipe\gntc.ipc`},
		{"data", "gntc.ipc", true, `\\.\pipe\gntc.ipc`},
		{"data", `\\.\pipe\gntc.ipc`, true, `\\.\pipe\gntc.ipc`},
	}
