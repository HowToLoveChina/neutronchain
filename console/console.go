...
import (
	...
	"github.com/ntc/go-ntc/internal/jsre"
	"github.com/ntc/go-ntc/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute ntc requests through
...
func (c *Console) init(preload []string) error {
	...
	flatten := "var ntc = web3.eth; var personal = web3.personal; "
	for api := range apis {
		if api == "web3" {
...
// Welcome show summary of current Gntc instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Gntc metadata
	fmt.Fprintf(c.printer, "============== Gntc ==============\n")
	c.jsre.Run(`
