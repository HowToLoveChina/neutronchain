...
import (
	...
	"github.com/ntc/go-ntc/crypto/ecies"
	"github.com/ntc/go-ntc/event/filter"
...
// Whisper represents a dark communication interface through the ntc
...
// New creates a Whisper client ready to communicate through the ntc P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
