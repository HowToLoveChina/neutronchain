...
import (
	...
	"github.com/ntc/go-ntc/logger"
	"github.com/ntc/go-ntc/p2p"
	"github.com/ntc/go-ntc/p2p/nat"
	"github.com/ntc/go-ntc/whisper"
)
...
func main() {
	...
	// Create an ntc peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting ntc peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start ntc peer: %v.\n", err)
		os.Exit(1)
	}
