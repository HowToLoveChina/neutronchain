...
// This file is part of go-ntc.
//
// go-ntc is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// go-ntc is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
// GNU General Public License for more details.
//
// You should have received a copy of the GNU General Public License
// along with go-ntc. If not, see <http://www.gnu.org/licenses/>.

// Package utils contains internal helper functions for go-ntc commands.
package utils
...
import (
	...
	"github.com/ntc/go-ntc/accounts/keystore"
	"github.com/ntc/go-ntc/common"
	"github.com/ntc/go-ntc/consensus/ethash"
	"github.com/ntc/go-ntc/core"
	"github.com/ntc/go-ntc/core/state"
	"github.com/ntc/go-ntc/core/vm"
	"github.com/ntc/go-ntc/crypto"
	"github.com/ntc/go-ntc/ntc"
	"github.com/ntc/go-ntc/ntc/downloader"
	"github.com/ntc/go-ntc/ntc/gasprice"
	"github.com/ntc/go-ntc/ntcdb"
	"github.com/ntc/go-ntc/ntcstats"
	"github.com/ntc/go-ntc/les"
	"github.com/ntc/go-ntc/log"
	"github.com/ntc/go-ntc/metrics"
	"github.com/ntc/go-ntc/node"
	"github.com/ntc/go-ntc/p2p"
	"github.com/ntc/go-ntc/p2p/discover"
	"github.com/ntc/go-ntc/p2p/discv5"
	"github.com/ntc/go-ntc/p2p/nat"
	"github.com/ntc/go-ntc/p2p/netutil"
	"github.com/ntc/go-ntc/params"
	whisper "github.com/ntc/go-ntc/whisper/whisperv5"
...
// for Gntc and returns half of the allowance to assign to the database.
...
func SetNodeConfig(ctx *cli.Context, cfg *node.Config) {
	...
	case ctx.GlobalBool(DevModeFlag.Name):
		cfg.DataDir = filepath.Join(os.TempDir(), "ntc_dev_mode")
	case ctx.GlobalBool(TestnetFlag.Name):
...
// RegisterEthService adds an ntc client to the stack.
func RegisterEthService(stack *node.Node, cfg *eth.Config) {
	...
	if err != nil {
		Fatalf("Failed to register the ntc service: %v", err)
	}
}
...
// RegisterEthStatsService configures the ntc Stats daemon and adds it to
// th egiven node.
func RegisterEthStatsService(stack *node.Node, url string) {
	if err := stack.Register(func(ctx *node.ServiceContext) (node.Service, error) {
		...
		var lesServ *les.Lightntc
		ctx.Service(&lesServ)

		return ethstats.New(url, ethServ, lesServ)
	}); err != nil {
		Fatalf("Failed to register the ntc Stats service: %v", err)
	}
}
...
func MakeChainDatabase(ctx *cli.Context, stack *node.Node) ntcdb.Database {
	var (
...
func MakeChain(ctx *cli.Context, stack *node.Node) (chain *core.BlockChain, chainDb ntcdb.Database) {
	var err error
...
// new format.
//
// e.g. gntc account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// gntc --keystore /tmp/mykeystore --lightkdf account new
//
