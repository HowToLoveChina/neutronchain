...
import (
	...
	"github.com/ntc/go-ntc/cmd/utils"
	"github.com/ntc/go-ntc/common"
	"github.com/ntc/go-ntc/console"
	"github.com/ntc/go-ntc/contracts/ens"
	"github.com/ntc/go-ntc/crypto"
	"github.com/ntc/go-ntc/ntcclient"
	"github.com/ntc/go-ntc/internal/debug"
	...
	"github.com/ntc/go-ntc/swarm"
	bzzapi "github.com/ntc/go-ntc/swarm/api"
...
var (
	...
	SwarmSwapAPIFlag = cli.StringFlag{
		Name:  "swap-api",
		Usage: "URL of the ntc API provider to use to settle SWAP payments",
	}
	...
	EnsAPIFlag = cli.StringFlag{
		Name:  "ens-api",
		Usage: "URL of the ntc API provider to use for ENS record lookups",
		Value: node.DefaultIPCEndpoint("gntc"),
	}
...
// This init function sets defaults so cmd/swarm can run alongside gntc.
func init() {
...
var app = utils.NewApp(gitCommit, "ntc Swarm")
...
Export a local chunk database as a tar archive (use - to send to stdout).
    ...
    swarm db export ~/.ntc/swarm/bzz-KEY/chunks chunks.tar

The export may be quite large, consider piping the output through the Unix
pv(1) tool to get a progress bar:

    swarm db export ~/.ntc/swarm/bzz-KEY/chunks - | pv > chunks.tar
`,
				},
				{
					Action:    dbImport,
...
Import chunks from a tar archive into a local chunk database (use - to read from stdin).
    ...
    swarm db import ~/.ntc/swarm/bzz-KEY/chunks chunks.tar

The import may be quite large, consider piping the input through the Unix
pv(1) tool to get a progress bar:

    pv chunks.tar | swarm db import ~/.ntc/swarm/bzz-KEY/chunks -
`,
				},
				{
					Action:    dbClean,
...
func detectEnsAddr(client *rpc.Client) (common.Address, error) {
	...
	block, err := ntcclient.NewClient(client).BlockByNumber(ctx, big.NewInt(0))
	if err != nil {
		return common.Address{}, err
	}
...
func registerBzzService(ctx *cli.Context, stack *node.Node) {
	...
	boot := func(ctx *node.ServiceContext) (node.Service, error) {
		...
		if ensapi != "" {
			...
			ensClient = ntcclient.NewClient(client)
