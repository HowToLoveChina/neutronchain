...
type wizard struct {
	...
	services map[string][]string   // ntc services known to be running on servers
...
// converts it to an ntc address. If an empty line is entered, the default
// value is returned.
