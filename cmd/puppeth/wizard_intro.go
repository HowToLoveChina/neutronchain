...
// setting up a new or managing an existing ntc private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your ntc private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new ntc network down to  |")
	...
	log.Info("Administering ntc network", "name", w.network)
